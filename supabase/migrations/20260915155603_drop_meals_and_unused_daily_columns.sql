-- Solo-user trim. DROP TABLE meals CASCADE destroys ~10 historical meal rows
-- from May 2026; that data loss is accepted. Unused daily_entries columns
-- (subjective 1–5 scales, empty body-comp/vitals, meal_notes) drop with their CHECKs.
