...
export const DAILY_METRICS = [
  ...
  "sleep_score",
  // Recovery / readiness vendor scalars. (training_status is text, not a
  // numeric metric, so it is intentionally excluded — get_stats/get_baseline
  // compute over numbers.)
  "stress_score",
