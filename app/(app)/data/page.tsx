...
export default async function DataPage({
  ...
  const [
    ...
    sb
      .from("daily_entries")
      .select(
        "id, date, sleep_h, sleep_deep_min, sleep_light_min, sleep_rem_min, sleep_awake_min, hrv_ms, rhr_bpm, spo2_avg_pct, respiration_avg_brpm, weight_kg, steps, active_calories, floors_climbed, intensity_min_moderate, intensity_min_vigorous, sleep_notes, wellness_notes",
      )
      .eq("user_id", user.id)
      .gte("date", sinceDate)
      .order("date", { ascending: false }),
